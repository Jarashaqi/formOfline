...
function SisaOrganikPupukForm() {
  ...
  const handleSave = () => {
    ...
    if (weightKg <= 0) {
      setSaveError('Berat pupuk harus lebih dari 0 kg')
      return
    }

    try {
      const entry = {
        formType: 'pupuk_sisa_organik',
        date: todayIso,
        userName,
        weightKg,
        place
  ...
  const isValid = weightKg > 0 && !!place
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="page-header">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="page-title">Pupuk dari Sisa Organik</h1>
      ...
      <div className="p-4 space-y-4">
        ...
        {saveSuccess && (
          <div className="card bg-gray-100 border-gray-200">
            ✓ Data pupuk dari sisa organik berhasil disimpan!
          </div>
        )}
        {saveError && (
        ...
        <div className="card">
          <div className="form-group">
            <label className="form-label">📍 Lokasi / Bed Pupuk</label>
            <input
              type="text"
              className="form-input"
              placeholder="Contoh: Bed Pupuk 1, Tumpukan Kompos A"
              value={place}
        ...
        <div className="card">
          <div className="form-group">
            <label className="form-label">⚖️ Berat Pupuk (kg)</label>
...
export default SisaOrganikPupukForm
