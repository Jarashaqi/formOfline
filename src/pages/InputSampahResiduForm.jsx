...
function InputSampahResiduForm() {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="page-header">
        <div className="flex justify-between items-center">
          <div>
            <h1 className="page-title">Input Sampah Residu</h1>
            <p className="page-subtitle">Catat berat sampah residu</p>
          </div>
          <button
...
export default InputSampahResiduForm
